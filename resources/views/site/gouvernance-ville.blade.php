@extends('layouts.app')
@section('title','Gouvernance Ville : Décentralisation et Compétences Locales à Casablanca.')
@section('description', 'Rôle clé des entités juridiques dans la gestion de Casablanca. Décentralisation, compétences locales renforcées.')
            ...
            <div class="row bg-white" style="margin-top: 25px;padding-bottom: 25px;">
                <div class="col-md-12" style="">
                    <h1 class=""
                        ...
                        Bref aperçu sur le rôle des différentes entités juridiques intervenant dans la gestion de la ville
                        de
                        Casablanca
                    </h1>
                    <p>
                        La décentralisation joue un rôle primordial dans le processus de développement des institutions
                        politiques et administratives du Royaume du Maroc. Ce processus a été marqué par des phases
                        importantes
                    ...
                    <p>
                        De ce fait, plusieurs entités juridiques interviennent dans la gestion de la commune du Grand
                        Casablanca
                    ...
                    <p style="color:#1e81e2!important;">
                        Notons que les compétences du Wali et du Gouverneur sont prévues par les articles 45 et suivantsde
                        la
                    ...
                    <p>
                        ...
                        <span style="font-size:15px;"> (Article premier du décret n° 2-03-727 du 2 kaada 1424 (26 décembre
                            2003)
                    ...
                    <p>
                        ...
                        territoriale interlocutrice privilégiée pour les investisseurs, doit être géré par un haut
                        fonctionnaire
                        dont le grade doit être en relation avec le niveau de ses responsabilités. C'est pourquoi nous avons
                        décidé qu'il serait nommé par Notre Majesté, choisi pour ses compétences dans le domaine concerné,
                        ainsi
                        que pour ses qualités humaines, et doté du statut de directeur d'administration centrale.Le centre
                        régional d'investissement a deux fonctions essentielles : l'aide à la création d'entreprises et
                        l'aide
                        aux investisseurs.
                        <span style="font-size:15px;"> (Lettre adressée par S.M. le Roi Mohammed VI au Premier ministre au
                            sujet
                    ...
                    <p>
                        ...
                        contribuer à la mise en œuvre de la politique de l'Etat en matière de développement, d'incitation,
                        de
                        promotion et d'attraction des investissements à l'échelon régional et d'accompagnement global des
                        entreprises, notamment les petites et moyennes entreprises et les très petites entreprises. En tant
                        que
                    ...
                    <p>
                        ...
                        régionales unifiées d’investissement traite des missions , des organes d’administration et de
                        gestion,
                    ...
                    <p>
                        D’après le Dahir portant loi n 1-84-188 du 13 Moharrem 1405 (9 octobre 1984) relatif à l'Agence
                        Urbaine
                        ...
                        l'autonomie financière et placé sous la tutelle du Ministre de l'Intérieur et le contrôle financier
                        de
                        l'Etat.
                    </p>
                    <p>
                        Dans les limites de sa compétence territoriale qui comprend l'ensemble des communes urbaines et
                        rurales
                    ...
                    <ul class="gouvernance-list">
                        <li>
                            Réaliser les études nécessaires à l'établissement du Schéma Directeur d'Aménagement Urbain du
                            Grand
                            Casablanca et de suivre l'exécution des orientations qui y sont définies.</li>
                        <li>Programmer les projets d'aménagement inhérents à la réalisation des objectifs du Schéma
                            Directeur.
                        </li>
                    ...
                    <p>
                        ...
                        La société de développement local (SDL) est l’un de ces outils novateurs de gestion de la chose
                        publique
                        qui s’inscrit dans le prolongement des expériences passées en matière de gestion de la chose
                        publique.
                    ...
                    <p>
                        ...
                        (infrastructures, mobilité, gestion des marchés communaux, animation culturelle, patrimoine…). Il
                        s’agit
                        essentiellement des SDL suivantes : Casa Aménagement, Casa Transport, Casa Prestations, Casa Events
                        et
